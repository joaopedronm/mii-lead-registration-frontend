...
const SportsArenaForm = ({ onSubmit }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // Envia os dados para o onSubmit, incluindo a categoria como "arenas"
        onSubmit({ ...formData, categoria: 'arenas' });
        ...
        <form onSubmit={handleSubmit}>
            ...
            <label>
                ...
                <textarea
                    ...
                    onChange={handleChange}
                    placeholder='Ex: Beach Tennis, Vôlei, Futvôlei, Funcional.'
                    required
                />
            </label>
            <label>
...
export default SportsArenaForm;
