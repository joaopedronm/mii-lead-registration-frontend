...
const KiteSchoolsForm = ({ onSubmit }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // Envia os dados para o onSubmit, incluindo a categoria como "kiteSchools"
        onSubmit({ ...formData, categoria: 'kiteSchools' });
...
export default KiteSchoolsForm;
